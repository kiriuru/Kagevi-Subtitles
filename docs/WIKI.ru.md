...
Руководство пользователя для **Kagevi Subtitles `0.6.4`** — как получить живые субтитры на стриме, что делает каждый экран и как чинить типичные проблемы.
...
Текущая линия: **`0.6.4`** (первый релиз Kagevi — `0.5.0`).
...
1. Запустите `Kagevi Subtitles_0.6.4_x64-setup.exe` (или свежий setup со [страницы релизов](https://github.com/kiriuru/Kagevi-Subtitles/releases)).
