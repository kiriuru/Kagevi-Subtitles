...
User guide for **Kagevi Subtitles `0.6.2`** — how to get live subtitles on stream, what each screen does, and how to fix common problems.
...
Current version line: **`0.6.2`** (first Kagevi release was `0.5.0`).
