...
Kagevi Subtitles (application source) is licensed under the [MIT License](./LICENSE).
...
| [Svelte](https://svelte.dev/) | Dashboard, worker, TTS, Local ASR UI | MIT |
...
For the full MIT text covering Kagevi Subtitles application code, see [LICENSE](./LICENSE).
