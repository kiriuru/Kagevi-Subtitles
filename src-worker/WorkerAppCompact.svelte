...
<div class="worker-page worker-page--compact">
  <main class="worker-layout worker-layout--compact">
    {#if ui.documentHidden}
      <div class="worker-notice worker-notice--alert worker-notice--compact" role="status">
    ...
    <section class="surface-card panel-padding worker-output-card">
