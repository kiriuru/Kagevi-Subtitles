...
pub fn assemble_local_asr_diagnostics(input: LocalAsrDiagnosticsInput<'_>) -> Value {
    ...
    json!({
        ...
        "vad_backend": input.config.vad.backend.as_str(),
        "silero_threshold": input.config.vad.silero_threshold,
        ...
        "text_hold_enabled": input.config.vad.text_hold_enabled,
        "text_hold_extra_ms": input.config.vad.text_hold_extra_ms,
